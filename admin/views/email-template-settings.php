		...
		<div class="yby-email-os__panel">
			...
			<table class="widefat striped yby-email-os__table">
				...
				<?php foreach ( $templates as $template ) : ?>
					<?php $registry_key = (string) ( $template['template_key'] ?? '' ); $template_edit_url = $this->template_editor_url( $template, $base_url ); $registry_note = (string) ( $owner_notes[ $registry_key ] ?? '' ); ?>
					<tr>
		...
		<div class="yby-email-os__panel">
			...
			<table class="widefat striped yby-email-os__table">
				...
				<?php foreach ( $woo_templates as $template ) : ?>
					<tr>
						<td><a class="yby-email-os__template-link" href="<?php echo esc_url( $template['editor_url'] ); ?>"><strong><?php echo esc_html( $template['label'] ); ?></strong><span aria-hidden="true">↗</span></a><br><code><?php echo esc_html( $template['source_id'] ); ?></code></td>
