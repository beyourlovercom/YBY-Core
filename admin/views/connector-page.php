	...
	<div class="yby-connector-columns">
		<section class="yby-connector-panel">
			...
			<form method="post" id="yby-connector-settings-form">
				...
				<p class="yby-connector-security-note">M7 已启用接口安全验证、6 个只读 GET 接口与 5 个 POST 接口，包含手工 Payout 完成回写。</p>
		...
		<div class="yby-connector-side">
			...
			<section class="yby-connector-panel">
				<h2>接口状态</h2>
				<p class="yby-connector-panel-description">M7 已开放 /health、5 个只读快照接口、2 个 Affiliate 写入接口、2 个 Coupon POST 接口与 1 个 Payout 完成接口。</p>
