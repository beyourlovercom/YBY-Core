	...
	<div class="yby-connector-columns">
		<section class="yby-connector-panel">
			...
			<form method="post" id="yby-connector-settings-form">
				...
				<p class="yby-connector-security-note">M5 已启用接口安全验证、5 个只读快照与 2 个 Affiliate 写入接口；Coupon/Payout 3 个 POST 接口尚未开放。</p>
		...
		<div class="yby-connector-side">
			...
			<section class="yby-connector-panel">
				<h2>接口状态</h2>
				<p class="yby-connector-panel-description">M5 已开放 /health、5 个只读快照接口与 2 个 Affiliate 写入接口；Coupon/Payout 3 个 POST 接口尚未开放。</p>
