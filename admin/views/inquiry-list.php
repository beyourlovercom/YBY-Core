...
<div class="wrap yby-inquiry-admin">
	...
	<?php foreach ( $data['items'] as $item ) : ?><tr>
		...
		<td><?php echo esc_html( $item['created_at'] ); ?></td><td><?php echo esc_html( $item['name'] ); ?></td><td><?php echo esc_html( $item['company'] ); ?></td><td><?php echo esc_html( $item['country'] ); ?></td><td><?php echo esc_html( $item['source_preset'] . ' / ' . $item['page_profile'] ); ?></td><td><?php echo esc_html( $item['status'] ?: 'new' ); ?></td><td><?php echo esc_html( $item['owner_user_id'] ?: 'Unassigned' ); ?></td><td><?php echo esc_html( $item['next_follow_up_at'] ?: '-' ); ?></td>
