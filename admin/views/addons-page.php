...
<th class="col-module">Addon</th><th class="col-desc">说明</th><th class="col-type">版本</th><th class="col-status">状态</th><th class="col-status">Core 兼容</th><th class="col-status">依赖</th><th class="col-action">进入</th>
</tr></thead><tbody>
<?php if ( empty( $addons ) ) : ?>
<tr><td colspan="7"><span class="description">当前没有已加载的 Andy Core Addon。Core-only / B2B 运行时保持干净。</span></td></tr>
...
<td><span class="yby-status-badge <?php echo 'ready' === $addon_status['state'] ? 'yby-status-ready' : 'yby-status-disabled'; ?>"><?php echo esc_html( 'ready' === $addon_status['state'] ? 'Ready' : 'Blocked' ); ?></span></td>
