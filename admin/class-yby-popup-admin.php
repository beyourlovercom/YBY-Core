...
class YBY_Popup_Admin {
	...
	public function render() {
		...
		if ( ! in_array( $tab, array( 'floating_inquiry', 'popup_inquiry', 'popup_subscribe', 'popup_lottery', 'shortcode_inquiry', 'shortcode_subscribe', 'bulk_marketing', 'email_templates' ), true ) ) { $tab = 'floating_inquiry'; }
