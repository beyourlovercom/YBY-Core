...
m4_assert( 'replay' === $content_replay['status'] && 901 === $content_replay['record']['result']['post_id'] && 'https://example.test/blog/test/' === $content_replay['record']['result']['url'], 'Content publish replay must preserve post identity and URL.' );
