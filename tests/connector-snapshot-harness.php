...
snapshot_assert( 12 === count( $routes ) && isset( $routes[ YBY_Connector::REST_NAMESPACE . '/affiliates/check' ] ), 'Connector must register six GET and six POST routes.' );
...
snapshot_assert( 6 === substr_count( $route_block, "'POST'" ), 'Exactly six POST routes must be registered.' );
