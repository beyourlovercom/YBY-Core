...
snapshot_assert( 11 === count( $routes ), 'M7 must register six GET and five POST routes.' );
...
snapshot_assert( 5 === substr_count( $route_block, "'POST'" ), 'Exactly five POST routes must be registered.' );
