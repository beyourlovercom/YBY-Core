...
require_once dirname(__DIR__).'/inc/class-yby-woo-order-export-audit.php';
...
$controller=file_get_contents(dirname(__DIR__).'/inc/class-yby-woo-order-export-controller.php');
...
$module=file_get_contents(dirname(__DIR__).'/inc/class-yby-woo-order-export-module.php');
