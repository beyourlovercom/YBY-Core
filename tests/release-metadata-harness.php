<?php
/** v1.9.0 release-candidate metadata + backward-compatible signed updater contract. */
...
$builder     = $read( 'scripts/build-v1.9.0-release.sh' );
...
$assert( false !== strpos( $plugin, 'Version:           1.9.0' ), 'PLUGIN_HEADER_VERSION_GATE failed.' );
$assert( false !== strpos( $plugin, "define( 'YBY_CORE_VERSION', '1.9.0' );" ), 'CORE_CONSTANT_VERSION_GATE failed.' );
...
$assert( false !== strpos( $version, 'Stable Version: 1.9.0' ) && false !== strpos( $version, 'Database Version: 1.5.0' ) && false !== strpos( $version, 'Updater Compatibility Database Version: 1.4.0' ), 'VERSION_MD_GATE failed.' );
$assert( false !== strpos( $readme, 'Product version: `1.9.0`' ) && false !== strpos( $readme, 'Database version: `1.5.0`' ) && false !== strpos( $readme, 'Updater compatibility database version: `1.4.0`' ), 'README_VERSION_GATE failed.' );
$assert( false !== strpos( $wp_readme, 'Stable tag: 1.9.0' ) && false !== strpos( $wp_readme, 'Tested up to: 7.1' ), 'README_METADATA_GATE failed.' );
$assert( false !== strpos( $changelog, '## v1.9.0 - 2026-09-24' ), 'CHANGELOG_RELEASE_GATE failed.' );

foreach ( array( 'RELEASE_NOTES_v1.9.0.md', 'UPGRADE_GUIDE_v1.9.0.md', 'ROLLBACK_GUIDE_v1.9.0.md' ) as $file ) {
	$assert( is_file( $root . '/' . $file ), 'Release/WP documentation missing: ' . $file );
}
foreach ( array( 'RELEASE_NOTES_v1.8.1.md', 'UPGRADE_GUIDE_v1.8.1.md', 'ROLLBACK_GUIDE_v1.8.1.md', 'scripts/build-v1.8.1-release.sh', 'RELEASE_NOTES_v1.8.0.md', 'UPGRADE_GUIDE_v1.8.0.md', 'ROLLBACK_GUIDE_v1.8.0.md', 'scripts/build-v1.8.0-release.sh', 'RELEASE_NOTES_v1.7.0.md', 'UPGRADE_GUIDE_v1.7.0.md', 'ROLLBACK_GUIDE_v1.7.0.md', 'scripts/build-v1.7.0-release.sh', 'RELEASE_NOTES_v1.6.0.md', 'UPGRADE_GUIDE_v1.6.0.md', 'ROLLBACK_GUIDE_v1.6.0.md', 'scripts/build-v1.6.0-release.sh', 'RELEASE_NOTES_v1.5.8.md', 'UPGRADE_GUIDE_v1.5.8.md', 'ROLLBACK_GUIDE_v1.5.8.md', 'scripts/build-v1.5.8-release.sh', 'RELEASE_NOTES_v1.5.7.md', 'UPGRADE_GUIDE_v1.5.7.md', 'ROLLBACK_GUIDE_v1.5.7.md', 'scripts/build-v1.5.7-release.sh', 'RELEASE_NOTES_v1.5.6.md', 'UPGRADE_GUIDE_v1.5.6.md', 'ROLLBACK_GUIDE_v1.5.6.md', 'scripts/build-v1.5.6-release.sh', 'docs/v1.5.6/ANDY-CORE-PUBLIC-RELEASE-CHANNEL-M2.md', 'RELEASE_NOTES_v1.5.5.md', 'UPGRADE_GUIDE_v1.5.5.md', 'ROLLBACK_GUIDE_v1.5.5.md', 'scripts/build-v1.5.5-release.sh', 'docs/v1.5.5/ANDY-CORE-v1.5.5-FIRST-NATIVE-UPGRADE-UAT.md', 'RELEASE_NOTES_v1.5.4.md', 'UPGRADE_GUIDE_v1.5.4.md', 'ROLLBACK_GUIDE_v1.5.4.md', 'scripts/build-v1.5.4-release.sh', 'docs/v1.5.4/ANDY-CORE-SECURE-UPDATER-M1.md', 'docs/v1.5.4/ANDY-CORE-RELEASE-AUTOMATION-M1.md', 'RELEASE_NOTES_v1.5.3.md', 'UPGRADE_GUIDE_v1.5.3.md', 'ROLLBACK_GUIDE_v1.5.3.md', 'scripts/build-v1.5.3-release.sh' ) as $file ) {
...
$assert( false !== strpos( $validation, 'php tests/secure-updater-harness.php' ) && false !== strpos( $validation, 'php tests/v190-addon-registry-harness.php' ) && false !== strpos( $validation, 'php tests/v190-addon-admin-harness.php' ) && false !== strpos( $validation, 'updater-backward-compat-harness.php' ) && false !== strpos( $validation, 'andy-core-v1.9.0-release-candidate' ), 'PR_RELEASE_VALIDATION_GATE failed.' );

foreach ( array(
	'admin/class-yby-commerce-admin.php',
	'admin/views/commerce-order-export.php',
	'inc/class-yby-woo-order-csv-streamer.php',
	'inc/class-yby-woo-order-export-controller.php',
	'inc/class-yby-woo-order-export-module.php',
	'inc/class-yby-woo-order-export-presets.php',
	'inc/class-yby-woo-order-query-adapter.php',
) as $commerce_file ) {
	$assert( ! is_file( $root . '/' . $commerce_file ), 'CORE_COMMERCE_BOUNDARY_GATE failed: ' . $commerce_file );
}
$addon_registry = $read( 'inc/class-yby-addon-registry.php' );
$assert( false !== strpos( $addon_registry, 'andy_core_register_addons' ) && false === stripos( $addon_registry, 'woocommerce' ), 'ADDON_REGISTRY_GENERIC_GATE failed.' );
