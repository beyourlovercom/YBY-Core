...
class YBY_Connector_Idempotency {
	...
	private static function allowed_result_key( $key ) { return in_array( $key, array( 'id', 'user_id', 'wp_user_id', 'affiliate_id', 'coupon_id', 'linked_affiliate_id', 'referral_id', 'referral_ids', 'payout_id', 'status', 'affiliate_status', 'success', 'retryable', 'exists', 'code', 'normalized_code', 'discount_type', 'amount', 'date_expires', 'currency', 'payout_method', 'created_user', 'created_affiliate' ), true ); }
