...
class YBY_Connector_Idempotency {
	...
	private static function allowed_result_key( $key ) { return in_array( $key, array( 'id', 'user_id', 'wp_user_id', 'wordpress_user_id', 'post_id', 'external_id', 'affiliate_id', 'coupon_id', 'linked_affiliate_id', 'referral_id', 'referral_ids', 'payout_id', 'status', 'affiliate_status', 'success', 'password_updated', 'retryable', 'exists', 'code', 'normalized_code', 'discount_type', 'amount', 'date_expires', 'date', 'currency', 'payout_method', 'created_user', 'created_affiliate', 'created', 'provider', 'resource_contract_version', 'url', 'layout_snapshot_id', 'preview_hash', 'canonical_path_expected', 'canonical_path_match', 'indexing' ), true ); }
