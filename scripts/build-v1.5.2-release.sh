...
output_dir="${RELEASE_OUTPUT_DIR:-${root_dir}/releases/v1.5.2}"
stage_dir="$(mktemp -d)"
package_name="andy-core-v1.5.2.zip"
...
case "${build_context}" in
  RELEASE_CANDIDATE)
    ...
    ;;
  FINAL_RELEASE)
    context_note='This package was regenerated from the final merged main commit for Andy Core v1.5.2 release.'
    ;;
  *)
